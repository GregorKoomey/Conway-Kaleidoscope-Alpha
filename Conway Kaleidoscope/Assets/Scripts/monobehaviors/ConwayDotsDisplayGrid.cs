...
public class ConwayDotsDisplayGrid : MonoBehaviour {
    ...
    private NativeHashMap<int, RenderMesh> renderers;
    private NativeArray<Entity> cellEntities;
    ...
    public void InitializeData(SparseGridIndexer index, NativeArray<byte> displayState, Color[] colorarray)
    {
        ...
        cellEntities = new NativeArray<Entity>(state.Length, Allocator.Persistent);
